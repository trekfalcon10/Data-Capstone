...
Initially, it appeared that fwd_model was completely superior, but this changed once applying the predctions to the test set.  The confusion matrices for the test set were as follows (using the new optimal thresholds of 0.034 and 0.046, respectively):  
